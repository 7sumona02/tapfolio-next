...
function Navbar1() {
    const navigationItems = [
        ...
        {
            title: "Product",
            description: "Smarter Connections, Greener Planet.",
            items: [
                {
                    title: "Features",
                    href: "/#features",
        ...
        <header
          ...
          <div className="px-5 container relative mx-auto h-20 flex gap-4 flex-row lg:grid lg:grid-cols-3 items-center">
                ...
                <div className="flex lg:justify-center">
                    <p className="font-bold text-xl">Tap<span className="text-green-600">folio</span></p>
                </div>
                ...
                <div className="flex w-12 shrink lg:hidden items-end justify-end">
                    ...
                    {isOpen && (
                        <div className="px-5 absolute top-20 border-t flex flex-col w-full right-0 bg-background shadow-lg py-4 container gap-8">
                            {navigationItems.map((item) => (
                                <div key={item.title}>
